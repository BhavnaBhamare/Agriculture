...
<form data-toggle="validator" action="AddMachinaryServlet" method="post" enctype="multipart/form-data">
								...
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									...
									<div class="form-body form-body-info">
											...
											<label style="color: white;">Machine Name</label>
												<input type="text" class="form-control" id="inputName" name="machinename" placeholder="machinename" required="">
											</div><br>
											
											<div class="form-group">
											<label style="color: white;">Machine Description</label>
											  <textarea value="Address" name="machinedescription" class="form-control" id="addrsess" data-match="#inputPassword" data-match-error="Whoops, these don't match"  placeholder="Machine Description" required=""></textarea>
											...
											<div class="form-group">
											<label style="color: white;">Machine Image</label>
