...
/**
 * Servlet implementation class Updatepfertilizerservlet
 */
@WebServlet("/Updatepfertilizerservlet")
@MultipartConfig(fileSizeThreshold=1024 * 1024 * 2,
maxFileSize = 1024 * 1024 * 70,
maxRequestSize = 1024 * 1024 * 100)
public class Updatepfertilizerservlet extends HttpServlet {
    ...
    public Updatepfertilizerservlet() {
        super();
    }
