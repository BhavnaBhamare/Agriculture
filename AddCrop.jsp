...
<form data-toggle="validator" action="AddCropServlet" method="post" enctype="multipart/form-data">
							...
							<div class="panel panel-widget agile-validation register-form">
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									...
									<div class="form-body form-body-info">
											...
											<label style="color: white;">Crop Name</label>
												<input type="text" class="form-control" id="inputName" name="cropname" placeholder="cropname" required="">
											</div><br>
											
											<div class="form-group">
											<label style="color: white;">Crop Details</label>
											  <textarea value="Address" name="cropdetails" class="form-control" id="addrsess" data-match="#inputPassword" data-match-error="Whoops, these don't match"  placeholder="Enter crop detail" required=""></textarea>
											  <div class="help-block with-errors"></div>
											</div><br>
											
											
											<div class="form-group">
											<label style="color: white;">Crop Seasion</label>
											  <input type="text" data-toggle="validator" data-minlength="6" class="form-control" id="inputPassword" name="cropseasion" placeholder="crop seasion" required="">
											</div><br>
											
											<div class="form-group">
											<label style="color: white;">Crop Image</label>
