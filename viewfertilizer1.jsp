...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	List<Addfertilizer> l=bl.searchfertilizer();
		...
		int fid=l.get(i).getFid();
		String fertilizername=l.get(i).getFertilizername();
		String fertilizerdetails=l.get(i).getFertilizerdetails();
		String fertilizerquantity=l.get(i).getFertilizerquantity();
		String fertilizerimage=l.get(i).getFertilizerimage();
		
		session.setAttribute("fid", fid);
		session.setAttribute("fertilizername", fertilizername);
		session.setAttribute("fertilizerdetails", fertilizerdetails);
		session.setAttribute("fertilizerquantity", fertilizerquantity);
		session.setAttribute("fertilizerimage", fertilizerimage);
						...
						<table border="5" id="example1" class="table table-bordered table-striped" >
											...
											<c:forEach items="${sessionScope.list }" var="a">
												<tr>
													...
													<td><a href="updatefertilizer.jsp?fid=${a.fid }">Edit</a></td>
													<td>Delete</td>
